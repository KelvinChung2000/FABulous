...
class Tile:
    ...
    def isPortInTile(self, port: GenericPort) -> bool:
        ...
        return any(port in bel.inputs or port in bel.outputs for bel in self.bels)
    ...
    @property
    def portsInfo(self) -> list[TilePort]:
        """Legacy compatibility property - flattens all ports."""
        return [port for ports in self.ports.values() for port in ports]

    @property
    def globalConfigBits(self) -> int:
        """Legacy compatibility property."""
        return self.configBits

    @property
    def matrixConfigBits(self) -> int:
        """Legacy compatibility property."""
        return self.switchMatrix.configBits

    @property
    def matrixDir(self) -> Path:
        """Legacy compatibility property - return tile directory."""
        return self.tileDir

    @property
    def wireList(self) -> list:
        """Legacy compatibility property - empty list for now."""
        return []

    @property
    def gen_ios(self) -> list:
        """Legacy compatibility property - empty list for now."""
        return []
