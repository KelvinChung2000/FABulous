...
- **Multi-process-node portability** -- Silicon-proven across TSMC 180nm, Skywater 130nm, and 28nm CMOS, with an IHP SG13G2 tapeout pending bring-up, demonstrating portability across foundry processes.
...
## FABulous and Alternative Offering?

| Feature | FABulous | OpenFPGA |
| :--- | :--- | :--- |
