module $__Mem #(
    ...
    parameter OPTION_cell_Mem_config_bits_1_ADDRESS_BITS = "16",
    parameter OPTION_cell_Mem_config_bits_1_DATA_WIDTH = "32",
    parameter PORT_RW0_ADDRESS_BITS = "16",
    parameter PORT_RW0_DATA_WIDTH = "32",
    parameter OPTION_cell_Mem_config_bits_0 = "1",
    parameter OPTION_cell_Mem_config_bits_0_ADDRESS_BITS = "16",
    parameter OPTION_cell_Mem_config_bits_0_DATA_WIDTH = "32",
    parameter PORT_RW0_ADDRESS_BITS = "16",
    parameter PORT_RW0_DATA_WIDTH = "32",
...
Mem #(
    ...
    .OPTION_cell_Mem_config_bits_1_ADDRESS_BITS(5'd16),
    .OPTION_cell_Mem_config_bits_1_DATA_WIDTH(6'd32),
