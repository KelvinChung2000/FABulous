...
from myProject.Tile.E_Mem_bot.metadata.E_Mem_bot_ports import E_Mem_bot_ports

class MuxList(E_Mem_bot_ports):
    ...
    def construct(self):
        ...
        self.addr0 //= self.addr_i
        self.out3 //= self.read_data
        self.write_data //= self.in3