...
class PE_ports:
    def __init__(self):
        ...
        self.spanIn = MuxPort(TilePort(name='spanIn', ioDirection=IO.INPUT, wireCount=2, isBus=False, sideOfTile=Side.EAST, terminal=False, spanning=False), isTilePort=True, isBus=False, bitWidth=2)
