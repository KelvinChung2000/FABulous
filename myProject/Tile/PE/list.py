...
class MuxList(PE_ports):
    ...
    def construct(self):
        ...
        self.out0 //= [self.in0, self.in1, self.in2, self.in3, self.N_reg_out]
        self.out1 //= [self.in0, self.in1, self.in2, self.in3, self.E_reg_out]
        self.out2 //= [self.in0, self.in1, self.in2, self.in3, self.S_reg_out]
        self.out3 //= [self.in0, self.in1, self.in2, self.in3, self.W_reg_out]
        ...
        self.N_pred_reg_in //= self.pred_in0
        self.E_pred_reg_in //= self.pred_in1
        self.S_pred_reg_in //= self.pred_in2
        self.W_pred_reg_in //= self.pred_in3
        self.l_A //= [self.pred_in0, self.pred_in1, self.pred_in2, self.data_in3, 
                      self.N_pred_reg_out, self.E_pred_reg_out, self.S_pred_reg_out, self.W_pred_reg_out]
        self.l_B //= [self.pred_in0, self.pred_in1, self.pred_in2, self.data_in3, 
                      self.N_pred_reg_out, self.E_pred_reg_out, self.S_pred_reg_out, self.W_pred_reg_out]
        self.pred_out0 //= [self.N_pred_reg_out, self.pred_in0, self.l_Y, self.Y]
        self.pred_out1 //= [self.E_pred_reg_out, self.pred_in1, self.l_Y, self.Y]
        self.pred_out2 //= [self.S_pred_reg_out, self.pred_in2, self.l_Y, self.Y]
        self.pred_out3 //= [self.W_pred_reg_out, self.pred_in3, self.l_Y, self.Y]
