...
class PE_ports:
    def __init__(self):
        ...
        self.RES_en = MuxPort(BelPort(name='en', ioDirection=IO.INPUT, wireCount=1, isBus=False, prefix='RES_', external=False), isBelPort=True, isBus=False, bitWidth=1)
        ...
        self.RES_rst = MuxPort(BelPort(name='rst', ioDirection=IO.INPUT, wireCount=1, isBus=False, prefix='RES_', external=False), isBelPort=True, isBus=False, bitWidth=1)
        ...
        self.N_en = MuxPort(BelPort(name='en', ioDirection=IO.INPUT, wireCount=1, isBus=False, prefix='N_', external=False), isBelPort=True, isBus=False, bitWidth=1)
        ...
        self.N_rst = MuxPort(BelPort(name='rst', ioDirection=IO.INPUT, wireCount=1, isBus=False, prefix='N_', external=False), isBelPort=True, isBus=False, bitWidth=1)
        ...
        self.E_en = MuxPort(BelPort(name='en', ioDirection=IO.INPUT, wireCount=1, isBus=False, prefix='E_', external=False), isBelPort=True, isBus=False, bitWidth=1)
        ...
        self.E_rst = MuxPort(BelPort(name='rst', ioDirection=IO.INPUT, wireCount=1, isBus=False, prefix='E_', external=False), isBelPort=True, isBus=False, bitWidth=1)
        ...
        self.S_en = MuxPort(BelPort(name='en', ioDirection=IO.INPUT, wireCount=1, isBus=False, prefix='S_', external=False), isBelPort=True, isBus=False, bitWidth=1)
        ...
        self.S_rst = MuxPort(BelPort(name='rst', ioDirection=IO.INPUT, wireCount=1, isBus=False, prefix='S_', external=False), isBelPort=True, isBus=False, bitWidth=1)
        ...
        self.W_en = MuxPort(BelPort(name='en', ioDirection=IO.INPUT, wireCount=1, isBus=False, prefix='W_', external=False), isBelPort=True, isBus=False, bitWidth=1)
        ...
        self.W_rst = MuxPort(BelPort(name='rst', ioDirection=IO.INPUT, wireCount=1, isBus=False, prefix='W_', external=False), isBelPort=True, isBus=False, bitWidth=1)
